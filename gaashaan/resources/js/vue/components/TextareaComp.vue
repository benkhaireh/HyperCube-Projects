    ...
    <div class="mb-4">
        ...
        <div class="relative w-full">
            ...
            <textarea
                v-bind="$attrs"
                :class="[
                    'shadow appearance-none border rounded w-full py-2 px-3 text-sm text-grey-darker pl-10 resize-none h-32 ' +
                        supclass,
        ...
        <p v-bind:class="{ 'text-red-600': generateErr }" class="hidden">
...
export default {
    ...
    computed: {
        checkChar: function() {
            if(this.totalChar == "") return "Caractères";

  ...
  <section class="bg-white">
    <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
      <div class="flex flex-col items-center max-w-sm mx-auto text-center">
        <p
          class="p-3 text-sm font-medium text-pink-500 rounded-full bg-pink-50"
        >
          <svg
        ...
        <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
          ...
          <button
            class="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-pink-500 rounded-lg shrink-0 sm:w-auto hover:bg-pink-600"
          >
            Take me home
          </button>
        </div>
